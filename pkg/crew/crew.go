...
var backstoryOrigins = map[engine.GenreID][]string{
	engine.GenreFantasy: {
		"Born in a small farming village at the kingdom's edge",
		"Raised among traveling performers and bards",
		"Orphaned young, grew up in temple care",
		"Second child of minor nobility, overlooked",
		"Apprenticed to a wandering craftsman",
		"Escaped from a conquered city",
		"Child of merchants who traveled the trade routes",
		"Grew up in the shadow of an ancient tower",
	},
	engine.GenreScifi: {
		"Born on a generation ship, never saw a planet",
		"Colony kid, raised in domes",
		"Station-born, artificial gravity is home",
		"Military family, lived on bases",
		"Corp creche graduate, company property",
		"Frontier world settler's child",
		"Refugee from a fallen colony",
		"Born during transit, citizenship unclear",
	},
	engine.GenreHorror: {
		"Was normal once, had a family",
		"Survived the first wave alone",
		"Woke up in a hospital, city was empty",
		"Military, unit was overrun",
		"Was studying abroad when it happened",
		"Prison survivor, walls kept things out",
		"Rural area, took time for it to spread",
		"Underground shelter, emerged to ruin",
	},
	engine.GenreCyberpunk: {
		"Combat zone kid, learned to run fast",
		"Corp brat, fell from grace",
		"Grew up in the sprawl, lower levels",
		"Orphan, raised by gang",
		"Middle class once, before the crash",
		"Test tube baby, designed purpose",
		"Refugee from a corpo war",
		"Nomad clan, roads are home",
	},
	engine.GenrePostapoc: {
		"Born in a vault, sealed from the world",
		"Tribal settlement, knew nothing else",
		"Wanderer's child, always moving",
		"Farming commune, worked the poisoned earth",
		"Pre-war baby, remembers the old world",
		"Scavenger camp, ruins were home",
		"Military bunker, strict discipline",
		"Floating community, water was safer",
	},
}

var backstoryMotivations = map[engine.GenreID][]string{
	engine.GenreFantasy: {
		"Seeks a cure for a loved one's curse",
		"Searching for a lost family member",
		"Running from an arranged marriage",
		"Wants to prove doubters wrong",
		"Owes a debt that must be repaid",
		"Drawn by visions of a distant place",
		"Seeking revenge for a past wrong",
		"Simply wants to see what lies beyond",
	},
	engine.GenreScifi: {
		"Searching for a new start",
		"Following a lead on family",
		"Running from corporate debt",
		"Seeking the truth about an incident",
		"Wants to find a mythical world",
		"Escaping a past life",
		"Looking for someone who disappeared",
		"Driven by scientific curiosity",
	},
	engine.GenreHorror: {
		"Believes there's a safe place somewhere",
		"Looking for anyone from before",
		"Just wants to survive another day",
		"Searching for answers about what happened",
		"Protecting someone who can't protect themselves",
		"Running from something specific",
		"Heard rumors of a cure",
		"Nowhere else to go",
	},
	engine.GenreCyberpunk: {
		"Chasing a big score to get out",
		"Wants revenge on a corporation",
		"Looking for a stolen family member",
		"Needs money for expensive treatment",
		"Running from a contract",
		"Seeking the truth about their past",
		"Wants to burn the system down",
		"Just trying to survive the streets",
	},
	engine.GenrePostapoc: {
		"Heard legends of a green place",
		"Searching for a lost settlement",
		"Looking for pre-war tech",
		"Following a map to somewhere better",
		"Running from raiders who destroyed home",
		"Seeking knowledge from the old world",
		"Protecting a precious resource",
		"Nowhere left to stay",
	},
}

var backstoryMemories = map[engine.GenreID][]string{
	engine.GenreFantasy: {
		"Remembers a stranger's kindness during hard times",
		"Once saw something magical in the woods",
		"A mentor taught them something important before dying",
		"Made a promise that hasn't been kept yet",
		"Witnessed an injustice that changed them",
		"Found something valuable, then lost it",
		"Saved someone once, it felt right",
		"A night when everything could have been different",
	},
	engine.GenreScifi: {
		"Saw a ship disappear into the unknown",
		"Had one perfect day on a beautiful world",
		"Lost everything in a sudden decompression",
		"Met someone important, never saw them again",
		"Survived something that should have killed them",
		"Made a discovery that was stolen",
		"Watched someone make the ultimate sacrifice",
		"A moment of clarity among the stars",
	},
	engine.GenreHorror: {
		"The last moment before everything changed",
		"Had to do something unforgivable to survive",
		"Saw someone they loved turn",
		"Found a moment of peace in the chaos",
		"Lost their first group, still dreams about it",
		"Made a choice that saved some but not all",
		"Remembers the world before, hurts too much",
		"Found something that gave them hope",
	},
	engine.GenreCyberpunk: {
		"The night they lost their organic parts",
		"Once lived in the upper levels, briefly",
		"Saw a friend flatline on a run",
		"Had a score go perfectly, just once",
		"The moment they realized the corps don't care",
		"Met someone famous in the shadows",
		"Lost everything to a hack attack",
		"A memory that might be implanted",
	},
	engine.GenrePostapoc: {
		"The day the old world ended",
		"Found a working device from before",
		"Lost someone to the wasteland",
		"Discovered a cache that saved their group",
		"Saw something beautiful in the ruins",
		"Made a trade they still regret",
		"A storm that changed everything",
		"Tasted clean water for the first time",
	},
}

var backstorySecrets = map[engine.GenreID][]string{
	engine.GenreFantasy: {
		"Carries a stolen heirloom",
		"Once betrayed someone for survival",
		"Knows more than they let on",
		"Has a bounty on their head",
		"Made a deal with something dark",
		"Isn't who they claim to be",
		"Hides a mark that means something",
		"Left someone behind who needed them",
	},
	engine.GenreScifi: {
		"Has illegal modifications hidden",
		"Knows classified information",
		"Identity is fabricated",
		"Carries contraband for someone",
		"Is running from an experiment",
		"Made a deal they can't escape",
		"Witnessed a covered-up incident",
		"Has a dormant condition",
	},
	engine.GenreHorror: {
		"Was bitten but hasn't turned",
		"Did something terrible in the early days",
		"Knows where supplies are hidden",
		"Recognizes the infected from before",
		"Carries something that attracts them",
		"Isn't sure if this is real anymore",
		"Caused an incident that killed others",
		"Hears things others don't",
	},
	engine.GenreCyberpunk: {
		"Has data someone would kill for",
		"Used to work for the enemy",
		"Owes the wrong people money",
		"Identity is completely fake",
		"Carries a kill switch implant",
		"Knows about a corporate conspiracy",
		"Is being tracked without knowing",
		"Made a deal with an AI",
	},
	engine.GenrePostapoc: {
		"Knows the location of a cache",
		"Used to be with a raider group",
		"Carries seeds worth killing for",
		"Knows how to make something dangerous",
		"Remembers the way to a safe place",
		"Has a pre-war skill they hide",
		"Betrayed their last group",
		"Carries a disease that might spread",
	},
}
