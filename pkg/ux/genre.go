...
func DefaultSkin(genre engine.GenreID) *UISkin {
	...
	case engine.GenreScifi:
		return buildScifiSkin()
	case engine.GenreHorror:
		return buildHorrorSkin()
	case engine.GenreCyberpunk:
		return buildCyberpunkSkin()
	case engine.GenrePostapoc:
		return buildPostapocSkin()
	default:
		return buildFantasySkin()
	}
}

// buildScifiSkin creates the sci-fi genre UI skin.
func buildScifiSkin() *UISkin {
	return &UISkin{
...
// buildHorrorSkin creates the horror genre UI skin.
func buildHorrorSkin() *UISkin {
	return &UISkin{
...
// buildCyberpunkSkin creates the cyberpunk genre UI skin.
func buildCyberpunkSkin() *UISkin {
	return &UISkin{
...
// buildPostapocSkin creates the post-apocalyptic genre UI skin.
func buildPostapocSkin() *UISkin {
	return &UISkin{
...
// buildFantasySkin creates the fantasy genre UI skin (default).
func buildFantasySkin() *UISkin {
	return &UISkin{
